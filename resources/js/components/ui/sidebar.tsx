...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative h-svh w-(--sidebar-width) bg-card transition-[width] duration-200 ease-linear",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile || state === "collapsed" ? <CircleChevronRight /> : <CircleChevronLeft />}
